...
namespace Hsm
{
    ...
    public class State
    {
        ...
        public virtual Transition EvaluateTransitions()
        {
        ...
        public StateType FindState<StateType>()
        ...
        public StateType FindOuterState<StateType>()
            where StateType : State
        {
            return mOwnerStateMachine.FindOuterStateFromDepth<StateType>(mStackDepth);
        }

        public StateType GetOuterState<StateType>()
            where StateType : State
        {
            StateType result = FindOuterState<StateType>();
            Debug.Assert(
                result != null,
                string.Format("Failed to get outer state on stack: {0}", typeof(StateType))
            );
            return result;
        }

        public bool IsInOuterState<StateType>()
            where StateType : State
        {
            return FindOuterState<StateType>() != null;
        }

        public bool HasInnerState()
        {
            return mOwnerStateMachine.HasStateAtDepth(mStackDepth + 1);
        }

        public StateType FindInnerState<StateType>()
            where StateType : State
        {
            return mOwnerStateMachine.FindInnerStateFromDepth<StateType>(mStackDepth);
        }

        public StateType GetInnerState<StateType>()
            where StateType : State
        {
            StateType result = FindInnerState<StateType>();
            Debug.Assert(
                result != null,
                string.Format("Failed to get inner state on stack: {0}", typeof(StateType))
            );
            return result;
        }

        public bool IsInInnerState<StateType>()
            where StateType : State
        {
            return FindInnerState<StateType>() != null;
        }

        public StateType FindImmediateInnerState<StateType>()
            where StateType : State
        {
            return mOwnerStateMachine.FindStateAtDepth<StateType>(mStackDepth + 1) as StateType;
        }

        public StateType GetImmediateInnerState<StateType>()
            where StateType : State
        {
            ...
            Debug.Assert(
                result != null,
                string.Format(
                    "Failed to get immeidate inner state on stack: {0}",
                    typeof(StateType)
                )
            );
            return result;
        ...
        public bool IsInImmediateInnerState<StateType>()
            where StateType : State
        {
            return FindImmediateInnerState<StateType>() != null;
        }
        ...
        public void SetAttribute<T>(StateValue<T> aStateValue, T aValue)
            where T : struct { }
    ...
    [Obsolete(
        "Renamed to StateValue<T> (Search & Replace \"Attribute\" with \"StateValue\")",
        true
    )]
    ...
    public class StateValue<T>
    {
        ...
        {
            __ValueToBeAccessedByStateMachineOnly = aInitialValue;
        }

        // Use to read value of StateValue
        public T Value
        {
            get { return __ValueToBeAccessedByStateMachineOnly; }
        }
    ...
    internal class StateValueResetterT<T> : StateValueResetter
    {
        ...
        public StateValue<T> StateValue
        {
    ...
    public struct Transition
    {
        ...
        public static Transition Inner<TargetStateType>()
            where TargetStateType : State
        {
            return Inner(typeof(TargetStateType), null);
        }

        public static Transition Inner<TargetStateType>(object arg1)
            where TargetStateType : State
        {
            return Inner(typeof(TargetStateType), arg1);
        }

        public static Transition Inner<TargetStateType>(object arg1, object arg2)
            where TargetStateType : State
        {
            return Inner(typeof(TargetStateType), arg1, arg2);
        }

        public static Transition Inner<TargetStateType>(object arg1, object arg2, object arg3)
            where TargetStateType : State
        {
            return Inner(typeof(TargetStateType), arg1, arg2, arg3);
        }

        public static Transition Inner<TargetStateType>(object[] args)
            where TargetStateType : State
        {
        ...
        public static Transition InnerEntry(
            Type aTargetStateType,
            object arg1,
            object arg2,
            object arg3
        )
        ...
        public static Transition InnerEntry<TargetStateType>()
            where TargetStateType : State
        {
            return InnerEntry(typeof(TargetStateType), null);
        }

        public static Transition InnerEntry<TargetStateType>(object arg1)
            where TargetStateType : State
        {
            return InnerEntry(typeof(TargetStateType), arg1);
        }

        public static Transition InnerEntry<TargetStateType>(object arg1, object arg2)
            where TargetStateType : State
        {
            return InnerEntry(typeof(TargetStateType), arg1, arg2);
        }

        public static Transition InnerEntry<TargetStateType>(object arg1, object arg2, object arg3)
            where TargetStateType : State
        {
            return InnerEntry(typeof(TargetStateType), arg1, arg2, arg3);
        }

        public static Transition InnerEntry<TargetStateType>(object[] args)
            where TargetStateType : State
        {
        ...
        public static Transition Sibling(
            Type aTargetStateType,
            object arg1,
            object arg2,
            object arg3
        ...
        public static Transition Sibling<TargetStateType>()
            where TargetStateType : State
        {
            return Sibling(typeof(TargetStateType), null);
        }

        public static Transition Sibling<TargetStateType>(object arg1)
            where TargetStateType : State
        {
            return Sibling(typeof(TargetStateType), arg1);
        }

        public static Transition Sibling<TargetStateType>(object arg1, object arg2)
            where TargetStateType : State
        {
            return Sibling(typeof(TargetStateType), arg1, arg2);
        }

        public static Transition Sibling<TargetStateType>(object arg1, object arg2, object arg3)
            where TargetStateType : State
        {
            return Sibling(typeof(TargetStateType), arg1, arg2, arg3);
        }

        public static Transition Sibling<TargetStateType>(object[] args)
            where TargetStateType : State
        {
    ...
    public class StateMachine
    {
        ...
        public void Init<InitialStateType>(object aOwner = null)
            where InitialStateType : State
        {
...
#pragma warning restore CS0618
        ...
        {
            get { return (int)TraceLevel; }
            set { TraceLevel = (TraceLevel)value; }
        }
            ...
            where StateType : State
        {
            ...
            Debug.Assert(
                result != null,
                string.Format("Failed to get state on stack: {0}", typeof(StateType))
            );
            return result;
        }
        ...
        public State FindStateAtDepth<StateType>(int aDepth)
            where StateType : State
        {
            return FindStateAtDepth(aDepth) as StateType;
        }

        public StateType FindOuterStateFromDepth<StateType>(int aDepth)
            where StateType : State
        {
        ...
        public StateType FindInnerStateFromDepth<StateType>(int aDepth)
            where StateType : State
        {
            Debug.Assert(aDepth >= 0 && aDepth < mStateStack.Count);
        ...
        public void VisitOuterToInner<StateType>(VisitState<StateType> aVisitor)
            where StateType : State
        {
            VisitStates<StateType>(aVisitor, mStateStack);
        }

        public void VisitInnerToOuter<StateType>(VisitState<StateType> aVisitor)
            where StateType : State
        {
        ...
        private void VisitStates<StateType>(
            VisitState<StateType> aVisitor,
            IEnumerable<State> aEnumerable
        )
            where StateType : State
        {
        ...
        private void EnterState(State aState, object[] aArgs)
        {
            ...
            if (mi != null) // OnEnter overridden on state
            {
                ...
                if (!haveArgs && expectsArgs)
                {
                    Debug.Fail(
                        String.Format(
                            "State {0} expects args, but none were passed in via Transition",
                            stateName
                        )
                    );
                }
                else if (haveArgs && !expectsArgs)
                {
                    Debug.Fail(
                        String.Format(
                            "State {0} does not expect args, but some were passed in via Transition",
                            stateName
                        )
                    );
                }
            ...
            else if (haveArgs)
            {
                Debug.Fail(
                    String.Format(
                        "Args are being passed via Transition to State {0}, but State doesn't implement OnEnter(params)",
                        stateName
                    )
                );
            }
        ...
        private bool ProcessStateTransitionsOnce()
        {
            if (mStateStack.Count == 0)
            {
                LogTransition(
                    TraceLevel.Basic,
                    0,
                    new Transition(TransitionType.Inner, mInitialStateType, null).ToString(),
                    mInitialStateType
                );
...
#pragma warning restore CS0618
                switch (trans.TransitionType)
                {
                    ...
                    case TransitionType.Inner:
                        ...
                        if (
                            immediateInnerState != null
                            && immediateInnerState.GetType() == trans.TargetStateType
                        )
                            break;
